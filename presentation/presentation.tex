...
\frame{
	...
	\textit{In practice}, it is easier to use an integrated development environment:
		\begin{itemize}
			\item installed on your computer: \alert{\TeX Studio} (\underline{\url{www.texstudio.org}}) 
				\begin{itemize}
...
\frame{
	...
	\begin{block}{Declarations}
		...
		\end{itemize}
		e.g. \texttt{\textbackslash centering},  \texttt{\textbackslash textit\{\}}
	\end{block}
